...
# Logging & plotting
loss_hist = np.loadtxt(os.path.join(log_dir, 'loss.csv'),
                   skiprows=1, delimiter=',')
log_p_train_hist = np.loadtxt(os.path.join(log_dir, 'log_p_train.csv'),
                   skiprows=1, delimiter=',')
log_p_test_hist = np.loadtxt(os.path.join(log_dir, 'log_p_test.csv'),
                   skiprows=1, delimiter=',')
cima_train_hist = np.loadtxt(os.path.join(log_dir, 'cima_train.csv'),
                   skiprows=1, delimiter=',')
cima_test_hist = np.loadtxt(os.path.join(log_dir, 'cima_test.csv'),
                   skiprows=1, delimiter=',')
kld_train_hist = np.loadtxt(os.path.join(log_dir, 'kld_train.csv'),
                   skiprows=1, delimiter=',')
kld_test_hist = np.loadtxt(os.path.join(log_dir, 'kld_test.csv'),
                   skiprows=1, delimiter=',')
amari_train_hist = np.loadtxt(os.path.join(log_dir, 'amari_train.csv'),
                   skiprows=1, delimiter=',')
amari_test_hist = np.loadtxt(os.path.join(log_dir, 'amari_test.csv'),
                   skiprows=1, delimiter=',')
mcc_train_hist = np.loadtxt(os.path.join(log_dir, 'mcc_train.csv'),
                   skiprows=1, delimiter=',')
mcc_test_hist = np.loadtxt(os.path.join(log_dir, 'mcc_test.csv'),
                   skiprows=1, delimiter=',')
last_iter = 150001
...
#Update the params from the old experiment
params = np.load((os.path.join(ckpt_dir, 'model_150000.npy')))
params = jax.tree_util.tree_unflatten(get_params(opt_state)._params, params)
opt_state = set_params(opt_state, params)

# Training
for it in range(last_iter, num_iter):
